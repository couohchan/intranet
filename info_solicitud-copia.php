    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i> BIENVENIDO INTRANET </li>
                        ...
                        <tbody>
                           ...
                           ?>
                              <tr>
                                ...
                                <td><?php  ?></td>
                                <td><?php  ?></td>
                                <td><a target="_blank" href="adjuntos/<?php  ?>"><?php  ?></a></td>
                                <?php if($rt->fields['estatus'] == 'AC'){ ?>
                                ...
                                <?php } elseif ($rt->fields['estatus'] == 'EP'){ ?>
                                <td><span class="label label-warning">En Proceso</span></td>
                                <td></td>
                                <?php } elseif ($rt->fields['estatus'] == 'CA'){ ?>
